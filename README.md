# Interpreter-in-ASM
A small 4 instruction interpreter built in ASM using custom [./Instruction Set.pdf](6502 instruction set) provided by Brian Gormanly, professor of Organization and Architecture at Marist University.
